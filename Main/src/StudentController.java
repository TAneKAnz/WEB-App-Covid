...
public class StudentController implements Initializable{
    ...
    void Add_teacher(MouseEvent event) throws IOException {
        ...
        Parent root = Loadresearch.loadFXML("Add_Student");
    ...
    void EditRec(ActionEvent event) throws IOException{
        ...
        Edit("recordStu.txt",IdTemp,FName.getText(),LName.getText(), ChoiceCovid.getValue(), ChoiceVaccine.getValue(), FDose.getValue(), SDose.getValue(), TDose.getValue(), FthDose.getValue());
        }
    }
